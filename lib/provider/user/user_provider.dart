...
import 'package:businesslistingapi/ui/common/facebook_login_web_view.dart';
...
import 'package:businesslistingapi/viewobject/holder/apple_login_parameter_holder.dart';
import 'package:businesslistingapi/viewobject/holder/facebook_login_user_holder.dart';
import 'package:businesslistingapi/viewobject/holder/fb_login_parameter_holder.dart';
import 'package:businesslistingapi/viewobject/holder/google_login_parameter_holder.dart';
...
class UserProvider extends PsProvider {
  ...
  Future<fb_auth.User> _getFirebaseUserWithGoogleId() async {
    try {
      ...
      final AuthCredential credential = fb_auth.GoogleAuthProvider.credential(
