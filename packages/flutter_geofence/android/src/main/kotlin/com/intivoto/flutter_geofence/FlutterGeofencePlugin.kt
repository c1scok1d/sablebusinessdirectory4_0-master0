...
class FlutterGeofencePlugin : FlutterPlugin, MethodCallHandler, ActivityAware, PluginRegistry.RequestPermissionsResultListener {
    ...
    private  val TAG = "FlutterGeofencePlugin"
    ...
    override fun onMethodCall(@NonNull call: MethodCall, @NonNull result: Result) {
        ...
        Log.e(TAG, "onMethodCall: start:"+call.method  )
        if (call.method == "addRegion") {
            ...
            Log.e(TAG, "onMethodCall: startListeningForLocationChanges" )
    ...
    private fun startGeofencing2(context: Context) {
        context.let {
            geofenceManager = GeofenceManager(it, {
                handleGeofenceEvent(it)
            }, {
...
//    fun checkInside(circleLat: GeoRegion, longitude: Double, latitude: Double): Boolean {
